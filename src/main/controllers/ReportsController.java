...
public class ReportsController implements Initializable {
    ...
    private void handleExport() {
        FileChooser chooser = new FileChooser(); chooser.setTitle("Export Report"); String timestamp = LocalDateTime.now().format(DATE_FMT);
        if (isMonthlyTab) {
